...
+ ClassDesc\ 
	...
	+ \src\main\java\com\suji\classdesc
		|---  ClassUtil.java
		|---  Main.java
	+ \src\test\java\com\suji\classdesc
		|---  AppTest.java
...
3. src\main\java\com\suji\classdesc\Main.java
4. src\main\java\com\suji\classdesc\ref\Met.java
5. src\test\java\com\suji\classdesc\AppTest.java
...
<project xmlns="http://maven.apache.org/POM/4.0.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
  ...
  <artifactId>ClassDesc</artifactId>
...
public class ClassUtil {
	...
	public static void detailedDescription(LinkedHashSet<Class> set) {
		...
		for (Class cl : set) {
			// System.out.println(ClassUtil.getName(cl) + ":");
			if (cl.isInterface()) {
...
#### src\main\java\com\suji\classdesc\Main.java
...
#### src\test\java\com\suji\classdesc\AppTest.java
