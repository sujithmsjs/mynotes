...
class ReflectionEx_Panel extends JPanel {
    ...
    private void loadImage() {
        ...
        try {
            ...
            image = ImageIO.read(new File(Util.imageLoc));
        } catch (Exception ex) {

            Logger.getLogger(ReflectionEx_Panel.class.getName()).log(
