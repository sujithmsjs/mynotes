...
4. controller\EmployeeRestController.java
...
9. src\main\java\com\example\demo\advice\EmployeeControllerAdvice.java
10. src\main\java\com\example\demo\excep\CustomExceptionDetails.java
11. src\main\java\com\example\demo\excep\EmployeeNotFoundException.java
12. src\main\java\com\example\demo\service\impl\EmployeeServiceImpl.java
13. resources\data.sql
14. resources\templates\index.html
15. src\test\java\com\example\demo\Demo5ApplicationTests.java
...
### 9. EmployeeControllerAdvice.java
...
### 10. CustomExceptionDetails.java
...
### 11. EmployeeNotFoundException.java
...
INSERT INTO employees(name,salary,role) values('Sujith',40000,'MNG');
INSERT INTO employees(name,salary,role) values('Vikram',70000,'HRBB');
INSERT INTO employees(name,salary,role) values('Surya',35000,'TL');
INSERT INTO employees(name,salary,role) values('KamalHasan',90000,'SE');
```
...
### 15. Demo5ApplicationTests.java

#### src\test\java\com\example\demo\Demo5ApplicationTests.java
